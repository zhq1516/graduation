...
<body>
    <div id="articleTable" class="modal bootstrap-dialog fade" tabindex="-2" role="dialog" aria-labelledby="articleTableModalLabel" aria-hidden="true" data-backdrop="static">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header form-header">
                    <div class="bootstrap-dialog-header">
                        ...
                        <div class="bootstrap-dialog-title" id="wifePhysiqueInfoTableModalLabel">文章信息</div>
                    </div>
                </div>
                <!-- 内容 -->
                        ...
                        <div class="bootstrap-dialog-message">
                            <div>
                                <div class="panel panel-default" style="border-radius: 0">
                                    <form id="articleInfoForm" enctype="multipart/form-data">
